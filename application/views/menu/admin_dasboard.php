...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    <li><a class="app-menu__item active" href="<?php echo base_url(); ?>admin/food/dryFood"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dry Food</span></a></li>

    <li><a class="app-menu__item" href="<?php echo base_url(); ?>admin/food/waterFood"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Water Food</span></a></li>
